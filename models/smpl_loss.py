...
from .smpl_utils import batch_rodrigues, perspective_projection
...
class SMPLLoss(nn.Module):
    ...
    def __init__(self, beta=1.0, reduction='mean', loss_weight=1.0,
                 ...
                 kpts_loss_type='L1Loss', kpts_3d_loss_type='MSELoss', img_size=[832, 512],
                 nr_batch_rank=True, inner_robust_sdf=None, **kwargs):
    ...
    def forward(self,
        ...
        if self.nr_batch_rank:
            ...
            loss_dict.update({'loss_batch_rank': batch_rank_loss.mean(), 'num_intruded_pixels': num_intruded_pixels.mean()})
...
class OrigSMPLLoss(nn.Module):
    ...
    def __init__(self, beta=1.0, reduction='mean', loss_weight=1.0, re_weight=None,
        ...
        super(OrigSMPLLoss, self).__init__()
        self.beta = beta
        self.reduction = reduction
        self.loss_weight = loss_weight
        self.criterion_shape = nn.L1Loss()
